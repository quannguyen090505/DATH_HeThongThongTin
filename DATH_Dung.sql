...
--
-- Host: localhost    Database: dath_hethongthongtin
-- ------------------------------------------------------
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `TaoPhieuDatBan` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `TaoPhieuDatBan`(
    IN p_MaBanAn INT, 
...
BEGIN
    IF EXISTS (
        SELECT 1 FROM phieudatban 
        WHERE MaBanAn = p_MaBanAn 
        AND ABS(TIMESTAMPDIFF(MINUTE, NgayGioNhanBan, p_NgayGioNhanBan)) < 180 
        AND TinhTrang IN ('ChoNhanBan', 'DaNhanBan')
    ) THEN
        SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'Bàn đã có lịch đặt trước trong khung giờ này (cách nhau dưới 3 tiếng).';
    ELSE
        INSERT INTO phieudatban (MaBanAn, NgayGioNhanBan, SDTKhach, MaNhanVienPhucVu, TinhTrang)
        VALUES (p_MaBanAn, p_NgayGioNhanBan, p_SDTKhach, p_MaNV, 'ChoNhanBan');
    END IF;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `TaoPhieuGoiMon` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `TaoPhieuGoiMon`(
    IN p_MaBanAn INT, 
    IN p_MaNV INT, 
    IN p_SDTKhach CHAR(11)
)
BEGIN
    IF p_SDTKhach IS NOT NULL AND p_MaBanAn IS NULL THEN
        INSERT INTO phieugoimon (MaBanAn, MaNhanVienPhucVu, SDTKhach, NgayGioTaoPhieu)
        VALUES (NULL, p_MaNV, p_SDTKhach, NOW());


    ELSEIF p_MaBanAn IS NOT NULL AND p_SDTKhach IS NULL THEN
        IF EXISTS (
            SELECT 1 FROM phieugoimon p 
            LEFT JOIN hoadon h ON p.MaPhieuGoiMon = h.MaPhieuGoiMon
            WHERE p.MaBanAn = p_MaBanAn AND h.MaHoaDon IS NULL
        ) THEN
            SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'Bàn này đang có một phiếu gọi món chưa hoàn tất.';
        ELSE
            INSERT INTO phieugoimon (MaBanAn, MaNhanVienPhucVu, SDTKhach, NgayGioTaoPhieu)
            VALUES (p_MaBanAn, p_MaNV, NULL, NOW());
        END IF;
    ELSE
        SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'Sai quy tắc: Mang về cần SDT, Ăn tại quán cần MaBan (SDT để NULL).';
    END IF;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `TaoPhieuGoiMonTruoc` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `TaoPhieuGoiMonTruoc`(
    IN p_MaPhieuDatBan INT, 
    IN p_MaNV INT
)
BEGIN
    DECLARE v_MaBan INT;
    DECLARE v_NgayNhan DATETIME;
    DECLARE v_SDT CHAR(11);


    SELECT MaBanAn, NgayGioNhanBan, SDTKhach 
    INTO v_MaBan, v_NgayNhan, v_SDT
    FROM phieudatban 
    WHERE MaPhieuDatBan = p_MaPhieuDatBan;


    INSERT INTO phieugoimon (MaBanAn, MaNhanVienPhucVu, SDTKhach, NgayGioTaoPhieu)
    VALUES (v_MaBan, p_MaNV, v_SDT, v_NgayNhan);
    

    INSERT INTO dattruocmon (MaPhieuDatBan, MaPhieuGoiMon) 
    VALUES (p_MaPhieuDatBan, LAST_INSERT_ID());
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `ThemMonVaoPhieuGoiMon` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `ThemMonVaoPhieuGoiMon`(
    IN p_MaPhieuGoiMon INT, 
    IN p_MaMonAn INT, 
    IN p_SoLuong INT
)
BEGIN
    ...
    IF p_SoLuong <= 0 THEN
        ...
        WHERE MaPhieuGoiMon = p_MaPhieuGoiMon AND MaMonAn = p_MaMonAn;
    ELSE
        IF EXISTS (SELECT 1 FROM monduocgoi WHERE MaPhieuGoiMon = p_MaPhieuGoiMon AND MaMonAn = p_MaMonAn) THEN
            UPDATE monduocgoi 
            SET SoLuong = SoLuong + p_SoLuong
            WHERE MaPhieuGoiMon = p_MaPhieuGoiMon AND MaMonAn = p_MaMonAn;
            
            DELETE FROM monduocgoi WHERE MaPhieuGoiMon = p_MaPhieuGoiMon AND MaMonAn = p_MaMonAn AND SoLuong <= 0;
        ELSE
            INSERT INTO monduocgoi (MaPhieuGoiMon, MaMonAn, SoLuong)
            VALUES (p_MaPhieuGoiMon, p_MaMonAn, p_SoLuong);
        END IF;
    END IF;
END ;;
DELIMITER ;
...
-- Dump completed on 2026-05-08  9:08:25
